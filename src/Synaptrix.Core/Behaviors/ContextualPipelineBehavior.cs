...
namespace Synaptrix.Behaviors
{
        ...
        where TContext : ICommandPipelineContext, new()
    {
        ...
        /// <param name="request">The request instance.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        protected abstract ValueTask OnInbound(TContext context, TRequest request, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        protected abstract ValueTask OnOutbound(TContext context, TResponse response, CancellationToken cancellationToken);
    }
}
