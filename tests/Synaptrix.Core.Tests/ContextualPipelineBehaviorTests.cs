...
public class TestRequestHandler : IRequestHandler<TestRequest, string>, IRequestHandler<ErrorRequest, string>
{
    ...
    /// <param name="cancellationToken">The cancellation token</param>
    /// <returns>A task containing the string</returns>
    public ValueTask<string> Handle(ErrorRequest request, CancellationToken cancellationToken)
    {
        return new ValueTask<string>("Should not be called");
    }
}
    ...
    where TRequest : IRequest<TResponse>
{
    ...
    /// <param name="request">The request</param>
    /// <param name="cancellationToken">The cancellation token</param>
    protected override ValueTask OnInbound(SharedTestContext context, TRequest request, CancellationToken cancellationToken)
    {
        context.Counter++;
        return default;
    }
    ...
    /// <param name="cancellationToken">The cancellation token</param>
    protected override ValueTask OnOutbound(SharedTestContext context, TResponse response, CancellationToken cancellationToken)
    {
        return default;
    }
}
    ...
    where TRequest : IRequest<TResponse>
{
    ...
    public ValueTask<TResponse> Handle(TRequest request, RequestHandlerDelegate<TResponse> next, CancellationToken cancellationToken)
    {
        ...
        if (request is ErrorRequest)
        {
            ...
            return new ValueTask<TResponse>((TResponse)(object)"Error occurred");
        }
